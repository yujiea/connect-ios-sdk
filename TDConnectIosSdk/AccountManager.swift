...
open class TelenorConnectConfig: Config {
    ...
    :param: accountId this unique id is used by AccountManager to identify the OAuth2 client.
    */
    public init (clientId: String, redirectUrl: String, useStaging: Bool, scopes: [String], accountId: String, webView: Bool, useBiometrics: Bool = false, claims: Set<String>? = nil, optionalParams: [String:String]? = nil, isPublicClient: Bool = true) {
